...
class _UserProfileWidgetState extends State<UserProfileWidget> {
  ...
  void initState() {
    ...
    _model.nameInputController ??=
        TextEditingController(text: FFAppState().userProfile.name);
    _model.nameInputFocusNode ??= FocusNode();

    _model.bussinessUnitInputController ??=
        TextEditingController(text: FFAppState().userProfile.businessUnit);
    _model.bussinessUnitInputFocusNode ??= FocusNode();

    _model.titleInputController ??=
        TextEditingController(text: FFAppState().userProfile.title);
    _model.titleInputFocusNode ??= FocusNode();

    _model.locationInputController ??=
        TextEditingController(text: FFAppState().userProfile.location);
